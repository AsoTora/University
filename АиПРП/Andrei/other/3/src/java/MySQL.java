...
public class MySQL {
    private static final String dbURL = "jdbc:mysql://localhost:3306/sqlstud; user=root; password=nagibator3000";
    ...
    public static String get (String arg) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/translatedata", "root", "password");
