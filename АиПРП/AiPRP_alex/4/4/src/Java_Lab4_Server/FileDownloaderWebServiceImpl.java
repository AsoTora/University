...
public class FileDownloaderWebServiceImpl implements FileDownloaderWebService{
    ...
    {
        File f = new File("/Users/alekseytkachuk/Documents/test/");;
//        f = new File("/Users/alekseytkachuk/Documents/test/");
    ...
    public String GetFile(String name)
    {
        ...
        {
            try{
                file_content = new String(Files.readAllBytes(Paths.get("/Users/alekseytkachuk/Documents/test/" + name)));
