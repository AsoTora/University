...
/*
 Дполнить программу, написанную при выполнении лабораторной работы No9,
 функциями упорядочения массива структур по неубыванию заданного ключа. Результат вывести на экран
*/
...
int Bmain() {
    ...
    string path = "/home/aso/CLionProjects/lab_11/database.dtb";
    choose_db(path);
    ...
    do {
        cout << endl << endl << "Fstream DataBase menu"
             ...
             << endl << "8.Sort file via MergeSort. Key -- contacts age."
             << endl << "9.Sort file via QuickSort. Key -- contacts age."
             << endl << "q.Exit"
             << endl << endl << "Enter Choice: ";
        cin >> ch;
        cout << endl;

        // Да, я знаю, что лучше было использовать switch //
        if (ch == '1') { // add data
